...
CELLCHAT_DEEP <- here("output/4.downstream_pipelines/cellchat/data/cellchat_deep_pop.size.true_cell_type_short.rds")
CELLCHAT_SUPERFICIAL <- here("output/4.downstream_pipelines/cellchat/data/cellchat_superficial_pop.size.true_cell_type_short.rds")
CELLCHAT_MERGED <- here("output/4.downstream_pipelines/cellchat/data/cellchat_merged_pop.size.true_cell_type_short.rds")
...
# Outputs
OUTPUT_DIR <- here("output", "6.figure_preparation", "Figure_5_S4")
