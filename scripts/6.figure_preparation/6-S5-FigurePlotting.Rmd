...
DESEQ_STATS_CSV <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_6_S5/deseq2_stats.csv")

VISION_OBJECTS_LIST <- list(
  here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_6_S5/CamaraH_Dataset_VISION.rds")
  )
...
HEATMAP_LOG_CPM_RDS <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_6_S5/CamaraH_pseudobulk_log_CPM_count_matrix_for_heatmap.rds")
HEATMAP_METADATA_RDS <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_6_S5/CamaraH_metadata_for_heatmap.rds")
HEATMAP_CTS_RDS <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_6_S5/CamaraH_pseudobulk_count_matrix_for_ggplot.rds")



BULK_DIR <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_6_S5/Cleaned_Datasets")
BULK_META_DIR <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_6_S5/Experimental_Design")

MULTIOME_SEURAT_RDS <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_6_S5/multiome_seurat.rds")
...
##  Indexing file is access controlled and will be uploaded in dbGaP
## plotting chunk is thus commented out
