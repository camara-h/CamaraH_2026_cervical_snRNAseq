...
# Outputs
OUTPUT_DIR <- here("output", "6.figure_preparation", "Figure_6_S5")
...
df <- pseudobulk_deseq_dge %>% filter(str_detect(cell_type, filter_cell),
                    contrast.1 == "Deep", 
...
ggsave(file.path(OUTPUT_DIR,paste0("S6B_vision_umapplot_", hallmark, ".pdf")), gg_sup_a, width = 60 * scale_factor, height = 20 * scale_factor, units = "mm", bg = "white",  dpi = 600)
}
...
for(dataset in dataset_names){
  ...
  pdf(file.path(OUTPUT_DIR, paste("S4E", dataset, "hox_heatmap.pdf", sep= "_")), width = mm_to_in(180), height = mm_to_in(60))
  # # --- Plot heatmap ---
...
ggsave(
  filename = file.path(OUTPUT_DIR, paste0("6G-H_coverage_", goi, "_", idents_query,"_by_neck.region.pdf")),
  plot = p,
