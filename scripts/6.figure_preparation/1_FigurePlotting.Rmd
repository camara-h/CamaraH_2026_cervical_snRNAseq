...
SUBJECT_INFO_FILE <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_1/2023-09-14_SubjectInformationTable.xlsx"
)

PROPELLER_PROPORTIONS <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_1/propeller_cellular_proportions_table.csv"
)

PROPELLER_STATS <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_1/propeller_proportions_stat_table.csv"
)
