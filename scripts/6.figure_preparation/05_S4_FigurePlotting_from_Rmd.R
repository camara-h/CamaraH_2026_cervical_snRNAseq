...
CELLCHAT_DEEP <- here(
  "..",
  "data/Figure_5_S4/cellchat_deep_pop.size.false_cell_type_short.rds"
)
CELLCHAT_SUPERFICIAL <- here(
  "..",
  "data/Figure_5_S4/cellchat_superficial_pop.size.false_cell_type_short.rds"
)
CELLCHAT_MERGED <- here(
  "..",
  "data/Figure_5_S4/cellchat_merged_pop.size.false_cell_type_short.rds"
)


MEBOCOST_COMM_CSV <- here(
  "..",
  "data/Figure_5_S4/communication_result_multi.csv"
)
