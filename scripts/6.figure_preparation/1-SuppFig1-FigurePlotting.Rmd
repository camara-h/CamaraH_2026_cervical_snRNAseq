...
```{r}
total |> count(dataset_renamed)
total |> count(dataset_renamed, Normalized > 0.8, Normalized > 0.5,Normalized > 0.20)
```
# --- Plotting ---
``` {r fig.width = 1.968504, fig.height = 1.377953}
...
ggsave(file.path(OUTPUT_DIR, "S1B_thermogenic_sample_distribution.pdf"), plot = c, width = 50, height = 35, units = "mm", bg = "white",  dpi = 600)
