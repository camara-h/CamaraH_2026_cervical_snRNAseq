...
GAVRILA_TPM <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_S1/TPM_values.csv")
DIN_CTS <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_S1/Din2018_countmatrix.txt")
XUE_CTS <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_S1/Supplementary_Table_cervical_at_microarray.xlsx")
REF_MAP_APSC <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_S1/aspc_combined.rds") 
REF_MAP_ADIPO <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_S1/adipo_combined.rds") 

PROPELLER_PROPORTIONS <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_S1/propeller_cellular_proportions_table.csv" )
PROPELLER_STATS <- here(
  "..",
  "NeckAdipose/ocean_code_data/Figure_S1/proportions_stat_table.csv")
