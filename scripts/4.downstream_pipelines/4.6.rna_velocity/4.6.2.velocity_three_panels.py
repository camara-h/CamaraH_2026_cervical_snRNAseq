...
def preprocess_velocity(filtered_adata: ad.AnnData, diagnostics_handle=None) -> ad.AnnData:
    ...
    # Older scVelo workflow used in the original notebook.
...
def run_velocity(data_dir: Path, out_dir: Path, cell_type_metadata: Optional[Path]) -> None:
    ...
    with diagnostics_path.open("w") as diag:
        ...
        filtered_adata = preprocess_velocity(filtered_adata, diag)
        ...
        plot_velocity_subset(
            ...
            outfile=out_dir / "6I_velocity_adipocytes_all.pdf",
        ...
        plot_velocity_subset(
            ...
            outfile=out_dir / "S5G_velocity_adipocytes_Dsubject3_BAT.pdf",
            diagnostics_handle=diag,
        )
        ...
        plot_velocity_subset(
            ...
            outfile=out_dir / "S5F_velocity_adipocytes_Deep.pdf",
            diagnostics_handle=diag,
        )
